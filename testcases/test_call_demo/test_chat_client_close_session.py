...
"""
-------------------------------------------------
@File Name:test_chat_client_close_session.py 
@author: gaojie
@time:  2021/9/16 1:48 下午 
@function：
-------------------------------------------------
"""
# import os
...
#
# sheet_name = "chat_client_close_session"
# filename = os.path.join(DATA_DIR, "im_apicases.xlsx")
#
#
# @ddt
# class ChatClientCloseSessionTestCase(unittest.TestCase):
...
#
#     @data(*cases)
#     def test_chat_client_close_session(self, case):
#         # 第一步：准备用例数据
